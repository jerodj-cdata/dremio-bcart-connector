...
@SourceType(value = "BcartARP", label = "Bcart",uiConfig = "bcart-layout.json")
public class BcartConf extends AbstractArpConf<BcartConf> {
  private static final String ARP_FILENAME = "arp/implementation/bcart-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.bcart.BcartDriver";
